<div align="center">
  ...
  <h1 align="center">🇪🇹 Nile Pay</h1>
  <h3 align="center">Ethiopian Digital Payment Gateway</h3>

   <div align="center">
     A modern payment gateway designed for the Ethiopian market with authentic Ethiopian aesthetics and seamless banking integration.
    </div>
</div>
...
Built with Next.js, Nilepay is a financial SaaS platform that connects to multiple bank accounts, displays transactions in real-time, allows users to transfer money to other platform users, and manages their finances altogether. 
...
```bash
git clone https://github.com/amanuelzewdie/nilepay-app.git
cd nilepay-app
```
